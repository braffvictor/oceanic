    ...
    <section class="md:w-7/12 mx-auto w-11/12 pt-5">
      ...
      >
        <div class="flex justify-between items-center">
          ...
          <div class="text-right float-left relative transit">
            <svg-comp
            ...
            >
              <p
                class="p-1 py-3 px-2 active:bg-slate-200 hover:bg-slate-200 dark:text-slate-100 dark:hover:bg-slate-700 text-slate-900 dark:active:bg-slate-700"
                @click="
                  $router.push(
