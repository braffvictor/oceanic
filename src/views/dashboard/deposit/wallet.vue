    ...
    <main class="md:w-8/12 mx-auto">
      ...
      <section>
        <div class="mt-5 text-slate-900 dark:text-slate-100">
          ...
          <section
            class="border-green-400 border-2 bg-green-100 dark:bg-green-200 transit dark:border-green-500 rounded-xl p-3 flex mt-5 gap-4"
          >
            <SvgComp
              ...
              Sclass="stroke-green-400 dark:stroke-green-500"
            />
            <p class="text-green-400 dark:text-green-500 text-light text-sm">
              Send Only USDT-ERC20 to this deposit address. Sending any other
              coin or token to this address may result to the loss of your
              deposit.
            </p>
          </section>
          ...
          <div class="rounded-3xl dark:border-slate-500 py-4 px-1 mt-4">
            ...
            <p class="opacity-85 font-bold text-sm">Ethereum (ERC20)</p>
            ...
            <p
              class="opacity-85 font-bold break-words text-sm"
              @click="copyWallet('Ethereum Wallet Address')"
            >
            ...
            >
              ...
              <div class="relative w-full">
                <input
                  ...
                  "
                  id="proof"
                  class="file:bg-transparent file:w-0 file:px-0 file:mx-0 file:border-0 px-0 w-full mt-2 text-sm text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                  placeholder="Proof"
                  required
                />
                <label
