<template>
  <div class="min-h-screen">
    <main class="md:w-8/12 mx-auto">
      ...
      <section>
        <div class="mt-3 text-slate-900 dark:text-slate-100">
          <img src="@/assets/qrcode.png" alt="" class="mx-auto text-center" />

          <div class="border rounded-3xl dark:border-slate-500 p-4 mt-6">
            ...
            <div
              class="mt-2 p-3 rounded-xl bg-gray-200 dark:text-slate-100 text-slate-900 overflow-hidden dark:bg-slate-700 caret:slate-700 dark:caret-slate-100 h-[50px] has-[:focus]:ring-green-400 has-[:focus]:ring-1 outline-none transit relative z-0 flex items-center gap-x-3"
            >
              <div>
                <SvgComp
              ...
              <div class="relative w-full">
                ...
                <label
                  for="amount"
                  class="peer-focus:font-medium left-0 absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-3 scale-75 top-0 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-8 peer-focus:text-green-500 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 peer-focus:left-0"
