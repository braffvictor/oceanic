<template>
  <div class="min-h-screen">
    <main class="md:w-8/12 mx-auto">
      ...
      <!-- form like -->
      <section @click="user && !user.verified ? verifiedAlert() : () => {}">
        <form
          @submit="submit"
          :class="
            user && !user.verified
        ...
        >
          ...
          <section class="px-1 pb-4 mx-2">
            ...
            <d-button
              ...
              :class="user && !user.verified ? 'shadow-none' : null"
              >Submit</d-button
            >
          </section>
        </form>
...
function verifiedAlert() {
  userflowing.initAlert({
    is: true,
    message:
      "Please Contact Support To Verify Your Account In Order To Top Up Your Wallet Balance.",
    type: "info",
    timer: 4500,
  });
}
