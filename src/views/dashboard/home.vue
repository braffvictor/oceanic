    ...
    <section class="md:w-10/12 mx-auto">
      ...
      <section class="mt-5 select-none px-3">
        <div class="flex justify-between items-center">
          ...
          <p
            class="font-semibold flex items-center cursor-pointer active:text-green-500 transit group text-sm py-2 pl-2 text-green-500"
            @click.self="$router.push('/dashboard/view-all')"
          >
            View All<SvgComp
              Sclass="group-active:!stroke-green-500 !stroke-green-500"
              class="pt-1 inline"
