<template>
  ...
  >
    ...
    <div class="mx-auto text-center flex justify-center mt-18 md:mt-5 transit">
      <div
...
import registerComp from "@/components/extUtils/registerComp.vue";
import loginComp from "@/components/extUtils/loginComp.vue";
