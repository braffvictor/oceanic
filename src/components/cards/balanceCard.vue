<template>
  <!-- the balance card -->
  <main
    class="h-32 shadow-sm md:h-40 mx-auto rounded-3xl w-full md:w-full !bg-green-400 dark:!bg-green-500 p-5 md:p-6 relative text-slate-600 dark:text-slate-200 transit"
